...
def parse_args():
    ...
    parser.add_argument(
        "--target_data_path",
        type=str,
        help="path to .npy file of input data",
        default="data/Xval.npy",
    )
    parser.add_argument(
        "--output_data_path",
        type=str,
        help="path to output prediction in .npy file",
        default="prediction/pred.npy",
    )
    parser.add_argument(
        "--load_model_path",
        type=str,
...
def predict(args):
    ...
    result_array = result_array.reshape(
        (result_array.shape[0], result_array.shape[1], result_array.shape[2])
    )
