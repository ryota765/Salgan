...
def parse_args():
    ...
    parser.add_argument(
        "--gt_data_path",
        type=str,
        help="path to .npy file of ground truth data",
        default="data/Yval.npy",
    )
    parser.add_argument(
        "--prediction_data_path",
        type=str,
        help="path to .npy file of predicted results",
...
if __name__ == "__main__":
    ...
    auc_b, auc_s, nss, cc = metrics.SaliencyMetrics().calculate_metrics(
        pred_array, gt_array
    )
